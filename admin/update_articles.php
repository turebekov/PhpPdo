                    ...
                    <tr>
                        ...
                        <td valign="top">
						   ...
						   if(isset($title) && isset($meta_d) && isset($meta_k) && isset($date) && isset($description) && isset($text) && isset($author)){
							   ...
							   $pdo = pdo();
							$arr=$pdo->query("UPDATE articles SET title='$title',meta_d='$meta_d',meta_k='$meta_k',date='$date',description='$description',text='$text',author='$author' WHERE id='$id'");
							    
							   if(isset($arr)){
									echo "<p>Ваш статья успешно обнавлен!</p>";
							   }
							   else{ 
								   ("<p>Ваш статья не обнавлен!)</p>");
							   }
						   }
						   else{
