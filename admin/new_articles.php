...
?>
    ...
    <head>
        ...
        <title>Страница добавление нового статьи</title>
    </head>
    <body>
                    ...
                    <tr>
                        ...
                        <td valign="top">
						   ...
						   <p> 
								...
								<p>
								<label for="meta_k">
								Введите ключевые слова для статьи:<br>
								<input id="meta_k" name="meta_k"><br>
								</label>
								</p>
								<p>
								<label for="date">
								Введите дату добавление статьи:<br>
								...
								<p>
								<label for="text" >
								Введите полный текст статьи с тэгами:<br>
								...
								<p>
								<label for="author" >
								Введите автора статьи:<br>
								<input id="author" name="author"><br>
								</label>
								</p>
								<p>
								<input type="submit" value="Занести статью в базу" name="submit"> 
							</p>
						   </form>
